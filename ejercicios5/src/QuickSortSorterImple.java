...
public class QuickSortSorterImple implements Sorter<Object> {
    ...
    @Override
    public void sort(Object[] arr, Comparator<Object> c) {
        int size = arr.length;
     ...
     */
    public static void quicksort(Object[] a, int size, Comparator<Object> c) {
     ...
     */
    public static void quicksort(Object[] a, int left, int right, Comparator<Object> c) {
        int size = right - left + 1;
        switch (size) {
            case 0:
            case 1:
    ...
    private static int median(Object[] a, int left, int right, Comparator<Object> c) {
        int center = (left + right) / 2;
    ...
    private static int partition(Object[] a, int left, int right, int pivotIndex, Comparator<Object> c) {
        int leftIndex = left;
        int rightIndex = right - 1;
        while (true) {
